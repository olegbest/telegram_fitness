...
let stage = new mongoose.Schema(stageSchema);
...
let Model_telegram_fitness_bot_stageStates = telegram_fitness_bot.model('stagestates', stage);

console.log(Model_telegram_fitness_bot_stageStates);
...
module.exports.Model_telegram_fitness_bot_stageStates = Model_telegram_fitness_bot_stageStates;