...
const stageStatesModel = require('./databaseController').Model_telegram_fitness_bot_stageStates;
...
module.exports = {
    ...
    async find_stageStates(id) {
        return await stageStatesModel.findOne({id: id});
    },
    async update_stageStates(id, data) {
        return await stageStatesModel.findOneAndUpdate({id: id}, data);
    }
};